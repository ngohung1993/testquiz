...
$this->title = Yii::t('backend', 'Đề thi báo lỗi câu hỏi');
...
<div class="page-content " style="min-height: 602px;">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Đề thi báo lỗi</li>
    </ol>
                                ...
                                <div class="col-md-3">
                                    <div class="text-center" style="margin-top: 25px">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-default" href="<?=Url::to(['error'])?>">
                            ...
                            <?php foreach ($exams as $key => $value): ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td class="text-left column-key-name">
                                        <a class="text-left"
                                           href="<?= Url::to(['detail-error', 'id' => $value['id']]) ?>">
                                            <?= $value['title'] ?>
                                        </a>
                                    </td>
                                    ...
                                    <td class="text-center" style="width: 50px;">
                                        <div class="table-actions">
                                            <a href="<?= Url::to(['detail-error', 'id' => $value['id']]) ?>"
