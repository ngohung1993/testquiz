...
/* @var $locations array common\models\LocationMenu */

$this->title = 'Vị trí menu';
                    ...
                    <div class="filter_list inline-block filter-items-wrap">
                        <div class="filter-item form-filter filter-item-default">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <button class="btn btn-warning" style="height: 34px;">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <div class="wrapper-action">
                        <div class="btn-group">
                            <a class="btn btn-secondary" href="#" style="margin-top: 2px;">
                                <span class="fa fa-cog"></span>
                                Thao tác
                            </a>
                        </div>
                        <button class="btn btn-warning btn-show-table-options">
                            <span class="fa fa-search"></span>
                            Tìm kiếm
                        </button>
                    </div>
                    ...
                    <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        ...
                        <table class="table table-striped table-hover vertical-middle dataTable no-footer">
                            ...
                            <tr role="row">
                                ...
                                <th width="100px" class="text-left column-key-created_at sorting" style="width: 100px;">
                                    Khóa
                                </th>
                        ...
                        <div class="datatables__info_wrap">
                            ...
                            <div class="dataTables_info" id="table-posts_info" role="status" aria-live="polite">
                                <span class="dt-length-records">
                                    ...
                                    <span>1 - <?= count($locations) ?> trên tổng</span>
