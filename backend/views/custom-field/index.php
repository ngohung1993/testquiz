...
$this->title = Yii::t('backend', 'Cấu trúc thành phần');
...
<div class="page-content-wrapper">
    <div class="page-content " style="min-height: 986px;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Thành phần</li>
        </ol>
                        ...
                        <div class="widget meta-boxes">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="dd nestable-menu" id="tree-5aa383cc537d1">
                                    <?php FunctionHelper::show_custom_fields_nestable(CustomField::find()->asArray()->all()) ?>
                                </div>
                            </div>
                        </div>
                    </div>
