...
<div class="page-content " style="min-height: 602px;">
    ...
    <div>
        <div class="note note-success" style="display: none">
            <p>
                Vui lòng <strong class="current_language_text">duyệt chủ đề</strong> trước rồi mới tới duyệt đề thi.
            </p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 right-sidebar">
                <?php if($model->status == Topic::CHO_DUYET): ?>
