                ...
                <div class="theme-search">
                    ...
                    <div class="filter_list inline-block filter-items-wrap">
                        <div class="filter-item form-filter filter-item-default">
                            <input type="hidden" name="status" value="<?= /** @var TYPE_NAME $status */
                            $status ?>">
                            <div class="row">
                                <div class="col-md-3">
...
<!-- Modal -->
<div class="modal fade" id="sendReason" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="margin: 18px">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <input type="hidden" id="status-topic">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">Chủ đề:</label>
                            <p id="title-topic" style="color: red; font-weight: bold;"></p>
                        </div>
                        <div class="form-group">
                            <label for="" ><span id="label-reason">Lý do không duyệt chủ đề</span></label>
                            <textarea id="reason-topic" name="reason-topic" class="form-control" cols="30" rows="4" ></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" data-dismiss="modal" onclick="sendReasonChangeStatusTheme()">Xác nhận</button>
