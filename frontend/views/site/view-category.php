...
$this->registerMetaTag([
    'name' => 'keywords',
    'content' => $category['seoTool']['meta_keywords']
]);
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8">
                    <div style="margin-top: 20px">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 ">
                                <div class="body-middle-titel">
                                    <div class="middle-titel">
                                        <a href="<?= Url::to(['site/category', 'slug' => $category['slug']]) ?>">
                                            <?= $category['title'] ?>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <?php foreach (FunctionHelper::get_class_by_category_id($category['id']) as $key => $value): ?>
                                <span class="spansub">
                                    <a title="<?= $value['title'] ?>" style="color: #fff"
                                       href="<?= Url::to(['site/class', 'slug' => $value['slug']]) ?>">
                                        <?= $value['title'] ?>
                                    </a>
                                </span>
                            <?php endforeach; ?>
                        ...
                        <div class="row">
                            <?php foreach (FunctionHelper::get_exam_in_category_page_by_category_id($category['id'], 0)['exams'] as $key => $value): ?>
                        ...
                        <div class="row">
                            <div class="center" style="text-align: center">
                                <?= LinkPager::widget(['pagination' => FunctionHelper::get_exam_in_category_page_by_category_id($category['id'])['pages']]) ?>
                            </div>
                        </div>
                    </div>
                </div>
