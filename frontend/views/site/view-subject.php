...
$this->registerMetaTag([
    'name' => 'description',
    'content' => $subject['seoTool']['meta_description']
]);

$this->registerMetaTag([
    'name' => 'keywords',
    'content' => $subject['seoTool']['meta_keywords']
]);
$this->registerMetaTag([
    'property' => 'og:type',
    'content' => 'website'
...
$this->registerMetaTag([
    'property' => 'og:title',
    'content' => $subject['seoTool']['seo_title']
]);
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8">
                    <div style="margin-top: 20px">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 ">
                                <div class="body-middle-titel">
                                    <div class="middle-titel">
                                        <a href="<?= Url::to(['site/subject', 'slug' => $subject['slug']]) ?>">
                                            <?= $subject['title'] ?>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <?php foreach (FunctionHelper::get_topic_by_subject_id($subject['id']) as $key => $value): ?>
                                <span class="spansub">
                                <a title="<?= $value['title'] ?>" style="color: #fff"
                                   href="<?= Url::to(['site/topic', 'slug' => $value['slug']]) ?>">
                                    <?= $value['title'] ?>
                                </a>
                            </span>
                            <?php endforeach; ?>
                        ...
                        <div class="row">
                            <?php foreach (FunctionHelper::get_exam_by_subject_id($subject['id'])['exams'] as $key => $value): ?>
                                            ...
                                            <div class="row ">
                                                <div class="col-md-12 col-sm-12 col-xs-12 "
                                                    ...
                                                    <div class="pull-left box-classroom">
                                                        <a href="<?= Url::to(['site/class', 'slug' => FunctionHelper::get_class_by_exam_id($value['id'])['slug']]) ?>">
                        ...
                        <div class="row">
                            <div class="center" style="text-align: center">
                                <?= LinkPager::widget(['pagination' => FunctionHelper::get_exam_by_subject_id($subject['id'])['pages']]) ?>
                            </div>
                        </div>
                    </div>
                </div>
