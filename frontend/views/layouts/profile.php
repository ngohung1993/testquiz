...
$count_message = Message::find()->where(['user_id' => $user['id']])->andWhere(['status' => 0])->andWhere(['type' => Message::SEND_USER])->count();
?>
<?php $this->beginPage() ?>
    <!DOCTYPE html>
                ...
                <div class="ad_user_parent_top">
                    <h3 class="ad_user_name" style="padding-top: 0;margin-top: 4px">
                        ...
                        <div class="profile-follow">
                            <a href="<?= Url::to(['finance/index']) ?>" target="_blank"
                    ...
                    <div class="ad_user_list_view">
                        <ul>
                            <li>
                                <span class="ad_user_title">Tổng lượt bán</span>
                            ...
                            <div class="form-group">
                                <div class="ad_user_menu_left">
                                    <ul class="nav nav-tabs menu">
                                        <li>
                                            <a href="<?= Url::to(['profile/introduce']) ?>" class="icon_ttcn">
                                                <span class="fa fa-info-circle"></span>
                                                Giới thiệu
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['profile/information']) ?>" class="icon_ttcn">
                                        ...
                                        <li>
                                            <a href="<?= Url::to(['topic/index']) ?>" class="icon_qltl">
                                                <span class="fa fa-suitcase"></span>
                                                Chủ đề đã tạo
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['exam/index']) ?>" class="icon_qltl">
                                                <span class="fa fa-graduation-cap"></span>
                                                Đề thi đã tạo
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['exam/bought']) ?>" class="icon_qltl">
                                                <span class="fa fa-sort-amount-asc"></span>
                                                Đề thi đã mua
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['finance/index']) ?>" class="icon_qltc">
                                                <span class="fa fa-bank"></span>
                                                Tài chính
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['message/index']) ?>" class="icon_ttcn">
                                                <span class="fa fa-envelope-o"></span>
                                                Thông báo
                                                <span class="pull-right number-message"
                                                      style=" margin-top: -5px;"><?= $count_message ?></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['statistical/index']) ?>" class="icon_ttcn">
